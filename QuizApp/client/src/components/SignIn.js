		...
		<CoverPage>
			<div className="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700 m-4">
				<form className="space-y-6" onSubmit={(e) => handleSignIn(e)}>
					<h5 className="text-xl text-center font-medium text-gray-900 dark:text-black">Signin to our platform</h5>
					{/* email  */}
					<div>
					...
					<div className="flex items-start">
						<Link to="/forgot-password" className="ml-auto text-sm text-blue-700 hover:underline dark:text-blue-500">
							Forgot Password?
						</Link>
					</div>
					{/* forgot-Password */}
					...
					<button
						...
						{/* loading */}
						{loading ? (
							<svg aria-hidden="true" role="status" className="inline w-4 h-4 mr-3 text-white animate-spin ml-2" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path
