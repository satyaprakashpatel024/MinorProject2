							...
							<div className="relative flex h-16 items-center justify-between">
								...
								<div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
									<div className="flex flex-shrink-0 items-center">
										<img className="h-8 w-auto" src={quizLogo} alt="Your Company" />
									</div>
											...
											{navigation.map((item) => (
												<a
													...
													className={classNames(
														item.current ? "bg-gray-900 no-underline	 text-white" : "text-gray-300 hover:bg-gray-700 hover:text-white no-underline	",
												...
												<Menu.Item>
													{({ active }) => (
														<a
															...
															className={classNames(active ? "bg-gray-100 cursor-pointer" : "", "block px-4 py-2 text-sm cursor-pointer text-gray-700")}>
															Sign out
														</a>
													)}
												</Menu.Item>
